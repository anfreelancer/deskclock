...
package com.luteapp.deskclock.stopwatch;
...
import com.luteapp.deskclock.AnimatorUtils;
import com.luteapp.deskclock.BillingClientSetup;
import com.luteapp.deskclock.DeskClockFragment;
import com.luteapp.deskclock.LogUtils;
import com.luteapp.deskclock.R;
import com.luteapp.deskclock.StopwatchTextController;
import com.luteapp.deskclock.ThemeUtils;
import com.luteapp.deskclock.Utils;
import com.luteapp.deskclock.data.DataModel;
import com.luteapp.deskclock.data.Lap;
import com.luteapp.deskclock.data.Stopwatch;
import com.luteapp.deskclock.data.StopwatchListener;
import com.luteapp.deskclock.events.Events;
import com.luteapp.deskclock.uidata.TabListener;
import com.luteapp.deskclock.uidata.UiDataModel;
import com.luteapp.deskclock.uidata.UiDataModel.Tab;
...
import static com.luteapp.deskclock.uidata.UiDataModel.Tab.STOPWATCH;
...
public final class StopwatchFragment extends DeskClockFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle state) {
        ...
        if (mTime != null) {
            if (BillingClientSetup.isUpgraded(getActivity())) {
    ...
    public void onFabClick(@NonNull ImageView fab) {
        if (!BillingClientSetup.isUpgraded(getActivity())) return;
    ...
    private void doShare() {
        ...
        @SuppressWarnings("deprecation") final Intent shareIntent = new Intent(Intent.ACTION_SEND)
