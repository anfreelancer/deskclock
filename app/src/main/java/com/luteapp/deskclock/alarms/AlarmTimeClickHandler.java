...
package com.luteapp.deskclock.alarms;
...
import com.luteapp.deskclock.AlarmClockFragment;
import com.luteapp.deskclock.BillingClientSetup;
import com.luteapp.deskclock.LabelDialogFragment;
...
import com.luteapp.deskclock.ringtone.RingtonePickerActivity;
...
public final class AlarmTimeClickHandler {
    ...
    public void onDeleteClicked(AlarmItemHolder itemHolder) {
        if(!BillingClientSetup.isUpgraded(mContext)) return;
